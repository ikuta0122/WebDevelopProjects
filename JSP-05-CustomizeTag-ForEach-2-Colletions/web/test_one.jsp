...
<body>
	...
	%>
	<myTag:forEach_one items="${names }" var="name">
		${name }<br>
	</myTag:forEach_one>
	...
	%>
	<myTag:forEach_one items="${schools }" var="school">
		${school }<br>
	</myTag:forEach_one>
	...
	%>
	<myTag:forEach_one items="${infos }" var="info">
		${info }<br>
	</myTag:forEach_one>
	...
	%>
	<myTag:forEach_one items="${citys }" var="city">
		${city }<br>
	</myTag:forEach_one>
</body>
</html>